...
export const MAPS: GameMap[] = [
  ...
  },
  {
    ...
    // 巨鹿式：左缘上行 → 中间台阶栅栏（左 r=5 / 右 r=3）→ 右缘下行至唐僧；AI 镜像至 (0,0)
    path: [
      { c: -1, r: 7 }, { c: 0, r: 7 }, { c: 0, r: 6 }, { c: 0, r: 5 }, // 左边缘
      { c: 1, r: 5 }, { c: 2, r: 5 }, { c: 3, r: 5 }, // 栅栏左段
      { c: 3, r: 4 }, { c: 3, r: 3 }, // 台阶竖段
      { c: 4, r: 3 }, { c: 5, r: 3 }, { c: 6, r: 3 }, { c: 7, r: 3 }, // 栅栏右段
      { c: 7, r: 4 }, { c: 7, r: 5 }, { c: 7, r: 6 }, { c: 7, r: 7 }, { c: 7, r: 8 }, { c: 7, r: 9 }, // 右边缘
    ],
    tangseng: { c: 7, r: 9 },
    initialBlock: [
