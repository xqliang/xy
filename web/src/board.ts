...
export const MAPS: GameMap[] = [
  ...
  },
  {
    ...
    // 黄风岭（土）：左下角入场（-1,9）→ 沿 c1 上行至第6行 → 中部横行 → c5 下行 → 第8行右行 → 右下角唐僧。
    // 两头都到底（入场与唐僧都在底边 r9），中间向上弯成凹谷；与流沙河（左中入场/右侧谷）几何不同。
    path: [
      { c: -1, r: 9 }, { c: 0, r: 9 }, { c: 1, r: 9 }, // 底边左行入场（出界首点）
      { c: 1, r: 8 }, { c: 1, r: 7 }, { c: 1, r: 6 }, // 左谷内壁上行
      { c: 2, r: 6 }, { c: 3, r: 6 }, { c: 4, r: 6 }, { c: 5, r: 6 }, // 第6行中部横行（凹谷底）
      { c: 5, r: 7 }, { c: 5, r: 8 }, // 右谷内壁下行
      { c: 6, r: 8 }, { c: 7, r: 8 }, // 第8行右行
      { c: 7, r: 9 }, // 落到右下角唐僧
    ],
    tangseng: { c: 7, r: 9 },
    initialBlock: [
