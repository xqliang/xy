...
export const HELP_BLOCKS: HelpBlock[] = [
  ...
  { kind: 'step', n: 1, text: '点「征兵」花蟠桃，下方候选区会出现兵、铲子或神将字牌。' },
  ...
  {
    kind: 'body',
    text: '征兵得到的兵就是兵器：刀兵、枪天兵、天马骑兵、神箭手。它们是守路的主力，摆在妖怪必经之路上持续输出。',
  },
  {
    kind: 'body',
  ...
  {
    kind: 'body',
    text: '征兵有时会出神将字牌。把同一神将的两个字左右紧邻摆放，就会金框激活，成为场上强力单位，并自带技能。悟空（大圣）在场时，还能触发羁绊给全队增伤。',
  },
  {
    kind: 'body',
    text: '神将分满 3 与满 5：满 3 是前期过渡将，更容易抽到，最高升到 3 阶；满 5 是核心主将，更强但更稀有，最高可升到 5 阶。',
  },
  {
    kind: 'body',
    text: '同门派共享一字（如「郎」）。可先练满 3 过渡将拉高字牌阶，再换成同门派满 5 主将——激活时两边字牌会按较高阶对齐继承（只升不降，受该神将满级封顶）。',
  },
  {
    kind: 'body',
  ...
  {
    kind: 'body',
    text: '· 辅助：续命减速（观音）、炼丹加攻神将与兵器（老君）、缩短友军大招与兵器冷却（文殊）等。',
  },
  {
    kind: 'body',
  ...
  {
    kind: 'body',
    text: '点选神将可看攻击范围与大招 CD：范围环是普攻与对怪大招共用的射程；多数大招需圈内有怪才放，老君/文殊的友军大招只需 CD 就绪。',
  },
  {
    kind: 'body',
    text: '神将还可靠输出、技能与喂同将字牌在局内升阶；拆开双字或中间隔空会失效。',
  },
  { kind: 'link', id: 'codex-hero', text: '打开神将图鉴 ›' },
  { kind: 'gap', h: 14 },

  { kind: 'title', text: '神兵（武器）' },
  {
    kind: 'body',
    text: '每位神将有一件专属神兵。对局中神将攻击有机会掉落碎片，集齐后激活；重复获得可提升品质（白→金），提供攻击、攻速或范围加成。',
  },
  {
    kind: 'body',
  ...
  { kind: 'link', id: 'codex-hero', text: '神将图鉴 ›' },
