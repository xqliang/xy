...
export const GENERALS: GeneralDef[] = [
  ...
  { id: 'damang', name: '大蟒', chars: ['大', '蟒'], role: '过渡', rank: 'T2', skill: 'burst',
    skillName: '蟒影横扫', skillDesc: '小范围贯穿（过渡）', atk: 6.77, frq: 1.4, rge: 2, targets: 1.5, skillCd: 10, weight: 3, asset: 'hero-damang',
  ...
  { id: 'niulang', name: '牛郎', chars: ['牛', '郎'], role: '过渡', rank: 'T2', skill: 'ranged',
    skillName: '织云箭', skillDesc: '单体远距轻击（过渡）', atk: 9.35, frq: 1.3, rge: 2.5, targets: 1, skillCd: 11, weight: 3, asset: 'hero-niulang',
  ...
  { id: 'jinzha', name: '金吒', chars: ['金', '吒'], role: '过渡', rank: 'T2', skill: 'burst',
    skillName: '砍妖刀', skillDesc: '小范围火焰爆发（过渡）', atk: 7.3, frq: 1.3, rge: 2.5, targets: 1.5, skillCd: 11, weight: 3, asset: 'hero-jinzha',
  ...
  { id: 'hongpao', name: '红袍', chars: ['红', '袍'], role: '过渡', rank: 'T2', skill: 'burn',
    skillName: '赤焰', skillDesc: '命中后小范围灼烧（过渡）', atk: 6.72, frq: 1.4, rge: 2, targets: 1.5, skillCd: 10, weight: 3, asset: 'hero-hongpao',
  ...
  { id: 'qingniu', name: '青牛', chars: ['青', '牛'], role: '过渡', rank: 'T2', skill: 'stun',
    skillName: '牛角顶', skillDesc: '短距撞击轻晕并轻伤（过渡）', atk: 9.62, frq: 1.0, rge: 1.5, targets: 1.5, skillCd: 12, weight: 3, asset: 'hero-qingniu',
  ...
  { id: 'tiebei', name: '铁背', chars: ['铁', '背'], role: '过渡', rank: 'T2', skill: 'knock',
    skillName: '铁背开山', skillDesc: '小范围击退并轻伤（过渡）', atk: 8.22, frq: 1.2, rge: 2.0, targets: 1.5, skillCd: 12, weight: 3, asset: 'hero-tiebei',
  ...
  { id: 'liusha', name: '流沙', chars: ['流', '沙'], role: '过渡', rank: 'T2', skill: 'knock',
    skillName: '流沙涌', skillDesc: '短距轻击退并轻伤（过渡）', atk: 8.2, frq: 1.2, rge: 2, targets: 1.5, skillCd: 11, weight: 3, asset: 'hero-liusha',
  ...
  { id: 'fanyin', name: '梵音', chars: ['梵', '音'], role: '过渡', rank: 'T2', skill: 'heal',
    skillName: '梵音浅润', skillDesc: '弱减速与微量续命（过渡）', atk: 7.79, frq: 1.3, rge: 2.5, targets: 1.5, skillCd: 14, weight: 3, asset: 'hero-fanyin',
  ...
  { id: 'danjun', name: '丹君', chars: ['丹', '君'], role: '过渡', rank: 'T2', skill: 'buff',
    skillName: '小还丹', skillDesc: '短时弱提升武将与兵器攻击（过渡）', atk: 8.44, frq: 1.2, rge: 2.0, targets: 1.5, skillCd: 15, weight: 3, asset: 'hero-danjun',
  ...
  { id: 'huishu', name: '慧殊', chars: ['慧', '殊'], role: '过渡', rank: 'T2', skill: 'cdr',
    skillName: '慧光浅照', skillDesc: '略缩短友军大招与兵器冷却（过渡）', atk: 8.44, frq: 1.2, rge: 2.0, targets: 1.5, skillCd: 15, weight: 3, asset: 'hero-huishu',
