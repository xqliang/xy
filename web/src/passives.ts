...
export const PASSIVE_SKILLS: PassiveSkillDef[] = [
  {
    ...
    icon: '桃',
    cost: 75,
    desc: '每40s在空地自动种下1棵桃树；桃树可移动，同级可合并升级',
  },
  ...
  { id: 'jubaopen', name: '聚宝盆', icon: '盆', cost: 55, desc: '每击杀 4 个妖怪 +1 蟠桃' },
  ...
  { id: 'dinghai', name: '自动定海针', icon: '针', cost: 55, desc: '开局开辟 1 阵位，之后每 5 波再自动开 1' },
];
