...
export const PASSIVE_SKILLS: PassiveSkillDef[] = [
  ...
  { id: 'mojin', name: '摸金校尉', icon: '⛏', cost: 45, desc: '每次用铲子额外 +6 蟠桃' },
  { id: 'luoyangchan', name: '洛阳铲', icon: '🥄', cost: 50, desc: '每 45 秒自动获得 1 把铲子' },
  { id: 'yunshi', name: '陨石', icon: '☄', cost: 65, desc: '每波开始对最前妖怪造成较弱陨石伤害（×1.4）' },
  { id: 'yuni', name: '淤泥', icon: '🟤', cost: 50, desc: '出怪口附近妖怪移速 -18%' },
  { id: 'xianyuan', name: '仙缘幡', icon: '🎏', cost: 35, desc: '召唤成本 -1' },
  { id: 'jubaopen', name: '聚宝盆', icon: '💰', cost: 55, desc: '击杀额外 +1 蟠桃' },
  { id: 'hushen', name: '护身金光', icon: '🛡', cost: 40, desc: '唐僧 +1 血' },
  { id: 'zhuwang', name: '绊妖蛛网', icon: '🕸', cost: 55, desc: '妖怪移速 -10%' },
  { id: 'tongxin', name: '同心咒', icon: '❤', cost: 60, desc: '唐僧 +3 血（对手仅 +2）' },
  { id: 'dinghai', name: '自动定海针', icon: '🪡', cost: 55, desc: '立即开辟 1 阵位' },
];
