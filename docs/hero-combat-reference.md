...
> **过渡 base atk 对齐同门满5**（2026-08-20，推翻原方案A「过渡基础 atk 高于主力」）：
> 每个满3过渡武将的基础 `atk` = 同门满5主力的基础 `atk`，使满3@3 攻击力与满5@3 同档
> （如金吒@3 = 哪吒@3 ≈ 12.5、红袍@3 = 红孩@3 ≈ 8.9）。满5主力靠 tier4-5 更高上限与更强
> `frq`/`rge`/目标/技能取胜，保证 **满5主力 > 满3过渡**；同档内仍按角色 输出 > 控制 > 辅助 差异化。
