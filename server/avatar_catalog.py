...
def catalog() -> list[dict[str, Any]]:
    return [
        ...
        {"id": "general", "name": "将军", "unlock_type": "rank", "unlock_value": 3, "art": "hero-erlang"},
        {"id": "yaoguai", "name": "小妖", "unlock_type": "rank", "unlock_value": 4, "art": "hero-honghaier"},
        {"id": "longwang", "name": "龙王", "unlock_type": "rank", "unlock_value": 5, "art": "hero-bailong"},
        {"id": "clear_1", "name": "初通行者", "unlock_type": "clear", "unlock_value": 1, "art": "hero-shaseng"},
